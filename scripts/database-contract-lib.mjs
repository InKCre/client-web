...
export function generateProductionProfile(profile) {
  return formatTypeScript(
    `${[
      '// Generated by scripts/sync-database-contract.mjs. Do not edit by hand.',
      '',
      `export const canonicalProductionProfile = ${JSON.stringify(profile, null, 2)} as const`,
      '',
      'export type CanonicalProductionProfile = typeof canonicalProductionProfile',
      '',
    ].join('\n')}\n`,
    'production-profile.generated.ts'
  )
}
