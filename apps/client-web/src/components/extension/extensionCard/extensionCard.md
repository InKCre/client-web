...
- `setEnabled` (function, required): application-level selected-Peer control operation
...
- Keep setup availability independent of which Peer is selected for enablement control
